  ...
  asyncBridge(context) {
    return {
      ...
      getPluginConfig: async () => {
        console.log('talisk### getPluginConfig context.plugin.plugins', context.plugin.plugins);
        ...
        console.log('talisk### getPluginConfig read plugins', plugins);
        console.log('talisk### getPluginConfig read context.plugin.plugins', context.plugin.plugins);
