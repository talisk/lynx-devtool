  ...
  return () => {
    ...
    useEffect(() => {
      context.asyncBridge.getPluginConfig().then((plugin) => {
        console.log('talisk### getPluginConfig', plugin.plugins);
    ...
    const saveConfig = () => {
      context.asyncBridge
        ...
        .then(() => {
          console.log('talisk### savePluginConfig', plugins);
          console.log('Saved');
        });
      context.logger.sendEvent({
        name: 'action',
    ...
    const handleLocalPkgOk = async () => {
      ...
      try {
        ...
        console.log('talisk### pluginMeta', pluginMeta);
        ...
        if (pluginMeta.platformPlugin) {
          ...
          // http://localhost:28990/plugins/dist/react-lynx/devtools.js
        }
