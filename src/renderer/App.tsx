...
import NavMenu from '@/renderer/components/NavMenu/NavMenu';
...
import { HeaderWrapper } from '@/renderer/components/Header/Header';
import UnattachedDialog from '@/renderer/components/UnattachedDialog/UnattachedDialog';
...
import { initLastOpReport } from '@/renderer/utils/report';
import { sendStatisticsEvent } from '@/renderer/utils/statisticsUtils';
import { isInMobilePageMode } from '@/renderer/utils/const';
