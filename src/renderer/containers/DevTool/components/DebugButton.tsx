...
import DebugSvg from '@/renderer/assets/icons/debug.svg';
import { canUseCardDebug } from '@/renderer/services/device';
import useConnection from '@/renderer/store/connection';
import { IDeviceInfo } from '@/renderer/types/device';
import { getDebugMode } from '@/renderer/utils/const';
